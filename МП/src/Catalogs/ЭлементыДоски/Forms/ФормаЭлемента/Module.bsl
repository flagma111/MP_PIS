...
Процедура ВремяНапоминанияНажатие(Элемент)
	СтруктураДляФормированияКлюча = Новый Структура("Ключ", ПолучитьКлюч(Объект.Ссылка));
	ОткрытьФорму("РегистрСведений.Напоминания.Форма.ФормаЗаписи", СтруктураДляФормированияКлюча);
	Закрыть();
КонецПроцедуры

&НаСервереБезКонтекста 
Функция ПолучитьКлюч(Ссылка)
	Возврат РегистрыСведений.Напоминания.СоздатьКлючЗаписи(Новый Структура("Элемент", Ссылка));
КонецФункции
